    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px] ">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] cursor-pointer hover:underline font-medium text-[#0085FF] lg:text-[18px]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] cursor-pointer hover:underline font-medium text-[#00A424] lg:text-[18px]">
            Learn More{" "}
            <span>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium cursor-pointer hover:underline text-[#EB2891] lg:text-[18px]">
            Learn More{" "}
            <span>
